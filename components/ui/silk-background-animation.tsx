          ...
          <div className="text-center px-8">
            ...
            <p 
              className={`
                ...
                text-gray-300/90 mix-blend-overlay
                opacity-0
            ...
            >
              <Link 
                href="/contact" 
                className="bg-white text-black px-8 py-4 font-bold text-sm tracking-wide hover:bg-white/90 transition-all flex items-center gap-2 group hover:scale-105 active:scale-95"
              >
                Want Website
